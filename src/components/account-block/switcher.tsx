...
export interface AlertAndNotificationSwitcherRef {
  on: () => void;
  off: () => void;
}

interface AlertAndNotificationSwitcherProps {
  isOn?: boolean;
...
export const AlertAndNotificationSwitcher = memo(
  forwardRef<
    AlertAndNotificationSwitcherRef,
    AlertAndNotificationSwitcherProps
  >(
    (
      {
        isOn = false,
